            ...
            <div className="flex justify-center items-center h-screen">
                <div className="flex  shadow h-fit  max-w-screen-md mx-auto ">
                    <div className="bg-primary flex flex-col justify-center items-center gap-3  w-1/2 p-5">
                        ...
                        <button className=" text-white border border-white  py-1 px-8 lg:text-lg cursor-pointer hover:scale-105 transition-all text-sm rounded-l-full rounded-r-full my-2 hover:bg-white hover:text-primary ">Sign Up</button>
                    </div>
